...
Java_com_zhtj_plugin_im_live_srt_JNISrt_srtStartup(JNIEnv *env,jclass clazz) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_zhtj_plugin_im_live_srt_JNISrt_srtCleanup(JNIEnv *env,jclass clazz) {
...
Java_com_zhtj_plugin_im_live_srt_JNISrt_srtOpen(
        JNIEnv *env,
...
extern "C" JNIEXPORT jint JNICALL
Java_com_zhtj_plugin_im_live_srt_JNISrt_srtClose(
        JNIEnv *env,
...
extern "C" JNIEXPORT jint JNICALL
Java_com_zhtj_plugin_im_live_srt_JNISrt_srtSend(
                JNIEnv *env,
...
Java_com_zhtj_plugin_im_live_srt_JNISrt_srtRecv(
        JNIEnv *env,
        jobject /* this */, jlong srt) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_zhtj_plugin_im_live_srt_JNISrt_srtGetSockState(
        JNIEnv *env,
        jobject /* this */, jlong srt) {
...
Java_com_zhtj_plugin_im_live_srt_JNISrt_yv12RotationAnti(JNIEnv *env, jclass type, jbyteArray src_,
